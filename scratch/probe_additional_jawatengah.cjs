...
async function main() {
  await fetchUrl('https://cctv.magelangkota.go.id/map', 'magelangkota');
  await fetchUrl('https://cctv.pekalongankab.go.id/cctv', 'pekalongankab');
  await fetchUrl('https://cctv.cilacapkab.go.id/', 'cilacapkab');
}
